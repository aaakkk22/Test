...
require_once dirname(__DIR__) . '/../../vendor/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php';
...
class SmsLogic
{
    ...
    public static function getAcsClient() {
        ...
        $res = Db::name('sms_config')->field('app_key , app_password')->where('id = 1')->find();
        
        $accessKeyId = $res['app_key'];//读取配置文件中的短信密钥的ID
        $accessKeySecret = $res['app_password'];//读取配置文件中的短信密钥的KEY
     ...
     * @return stdClass
     */
    public static function sendSms($phoneNumbers,$signNam,$templateCode,$code=0,$templateParam=[]) {
